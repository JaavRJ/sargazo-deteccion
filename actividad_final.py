...
def analizar_sargazo_fotogrametria(
    ...
    espesor_biomasa_m : float Espesor usado para calcular volumen.
    capacidad_camion_m3 : float Capacidad usada para calcular camiones.
    mostrar : bool Muestra las figuras de matplotlib si es True.
    guardar_figura : str | None Ruta para guardar el diagnostico.
    devolver_mascaras : bool Incluye mascaras intermedias en el resultado.
    ...
    texto = (
        ...
        f"  Capacidad camión           : {capacidad_camion_m3:.1f} m³\n"
    ...
    if devolver_mascaras:
        resultado["mascaras"] = {
            "clahe": gray_eq,
            "positiva": mascara_positiva,
            "filtrada": mascara_filtrada,
            "morfologica": m5,
            "final": mascara_final,
        }
